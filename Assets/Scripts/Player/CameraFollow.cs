...
public class CameraFollow : MonoBehaviour
{
    ...
    public Transform target; // Assign Player GameObject's Transform here in the Inspector

    [Tooltip("The offset from the player's position.")]
    public Vector3 offset = new Vector3(0f, 0f, -10f); // Adjust this if camera's Z is different, or you want an X/Y offset
    ...
    void LateUpdate()
    {
        ...
        // for framerate-independent smoothing, but for camera follow,
        ...
        // Optional: To snap the camera to pixel grid for pixel art games:
